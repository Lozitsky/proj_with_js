...
// var stockCount = 0;
console.log(inStock < 1 ? `We need to get some more ${food}.` : `the statement 'I'm going to eat some ${food}!'`);
...
var vegetables = ["potato", "carrot", "bob", "tomato", "broccoli"];
...
// different fruits.
var fruits = ["banana", "orange", "apple", "avocado", "cherry", "cocos", "mango"];
