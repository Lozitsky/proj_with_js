...
describe('Recipe', () => {
  ...
  it('should store an id', function () {
    const recipe = new Recipe(595736, 'https://spoonacular.com/recipeImages/595736-556x370.jpg', ingredients, instructions, 'Loaded Chocolate Chip Pudding Cookie Cups', tags);
